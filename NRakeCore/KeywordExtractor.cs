...
namespace NRakeCore
{
    public class KeywordExtractor
    {
        ...
        public SortedList<string, WordScore> LeagueTable { get; private set; }
        ...
        /// <summary>
        /// Returns a KeywordExtractor initialized with the best stop-word filter for a given language/culture string.
